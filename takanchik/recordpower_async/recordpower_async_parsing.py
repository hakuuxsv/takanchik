...
def main():
    ...
    with open(f"recordpower_async/labirint_{cur_time}_async.json", "w", encoding="utf-8") as file:
        json.dump(books_data, file, indent=4, ensure_ascii=False)
    with open(f"recordpower_async/labirint_{cur_time}_async.csv", "w", encoding="utf-8") as file:
    ...
    for book in books_data:
        with open(f"recordpower_async/labirint_{cur_time}_async.csv", "a", encoding="utf-8") as file:
            writer = csv.writer(file)
            writer.writerow(
                (
                    book["book_title"],
